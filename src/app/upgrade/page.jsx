...
const PremiumPricingCard = () => {
  ...
  return (
    <div className="w-full  my-6 max-w-md mx-auto rounded-3xl border border-[#224764] bg-gray-900/80 backdrop-blur-md overflow-hidden shadow-2xl shadow-[#022b3f]/50">
      {/* TOP SECTION */}
