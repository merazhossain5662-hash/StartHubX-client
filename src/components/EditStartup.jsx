              ...
              <Modal.Body>
                <Form onSubmit={handleUpdate} className="space-y-5">
                    ...
                    <div className="flex gap-1">
                      ...
                      <label className="mt-1 w-full flex items-center justify-between gap-3 border border-[#83d5fe]/70 rounded-xl px-4 py-2 cursor-pointer hover:bg-indigo-500/10 transition">
                        ...
                        <input
                          type="file"
                          disabled={loading}
                          defaultValue={startupData?.profileImage}
                  ...
                  <Button
                    slot="close"
                    type="submit"
                    className="text-[#c4e1f0]/70 rounded-md hover:text-[#6998AB]  hover:bg-[#1e4360]/15 hover:rounded-lg transition-all duration-300 ease-in-out hover:translate-x-0.5 py-4 border border-[#2182cd] bg-[#1e4360]/50 px-3"
                  >
                    <Pencil></Pencil>
                    Update Now
                  </Button>
