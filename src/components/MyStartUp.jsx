        ...
        {startupData ? (
          <>
            <div className="flex gap-2">
              <DeleteStartup id={startupData._id}></DeleteStartup>
              <EditStartup startupData={startupData}></EditStartup>
            </div>
            <div>
              <Card className="max-w-150 bg-[#03111b]  hover:bg-[#021e34] border-gray-800 hover:border-[#224764] border backdrop-blur-2xl ">
                <Card.Content className="space-y-3">
                  <Card.Header className="flex flex-row gap-3">
                    <Avatar className="size-16 rounded-2xl">
                      <Avatar.Image
                        alt="Extra Large"
                        src={startupData?.profileImage}
                      />
                      <Avatar.Fallback className="bg-[#204561] text-lg">
                        {startupData.name?.[0].toUpperCase() || "?"}
                      </Avatar.Fallback>
                    </Avatar>
                    <div className="space-y-1">
                      ...
                      <div>
                        <Chip variant="outlined" color="primary">
                          <CircleFill width={6} />
                          <Chip.Label> {startupData.state}</Chip.Label>
                        </Chip>
                  ...
                  <Card.Footer>
                    {startupData.status === "pending" && (
                      <div className="bg-amber-500/20 text-amber-600 rounded-lg p-4 text-xs w-full flex items-center gap-2">
                        <span>
                          ⏳ Your startup is pending admin approval before it
                          appears publicly.
                        </span>
                      </div>
                    )}
...
export default MystartupComponent;
